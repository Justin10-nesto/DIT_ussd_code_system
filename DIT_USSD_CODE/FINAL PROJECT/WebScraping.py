...
class DIT_API:
    ...
    def result(self,email, password):
        ...
        try:
            ...
            if 'Welcome, you have successfully logged into your account' in p.text:
                ...
                result_url = (f'https://soma.dit.ac.tz/student-semester-results')
    ...
    def view_results(self,email,password):
        self.photo
        self.error
        try:
            login_url = 'https://soma.dit.ac.tz/login'
            ...
            if 'Welcome, you have successfully logged into your account' in p.text:
                ...
                person_info = (r'https://soma.dit.ac.tz/cstudent-semester-results')
                person_info = session.get(person_info).content
                print(person_info)
                results_url = pd.read_html(person_info)
                print((results_url))
                results_data = pd.DataFrame(results_url)
                return results_data
